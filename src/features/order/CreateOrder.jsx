...
function CreateOrder() {
  ...
  // this is hoook to get data from action  of route
    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <button disabled={isSubmitting} className="bg-yellow-400 uppercase font-semibold text-stone-800 py-3 px-4 inline-block rounded-full hover:bg-yellow-300 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:bg-yellow-300 focus:ring-offset-2   disabled:curser-not-allowed">
